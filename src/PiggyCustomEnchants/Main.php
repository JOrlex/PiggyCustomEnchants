...
class Main extends PluginBase
{
    ...
    public $enchants = [
        ...
        CustomEnchantsIds::BLESSED => ["Blessed", "Weapons", "Damage", "Uncommon", 5, "15l% (l = level) chance to remove bad effects"],
        ...
        CustomEnchantsIds::OVERLOAD => ["Overload", "Armor", "Equip", "Mythic", 10, "Gives 1 extra heart per level per armor piece"],
